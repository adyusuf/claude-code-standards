...
Oku: `~/.claude/standards/` → `15-security.md` (§12 OWASP, §15 checklist), `20-hardening.md`,
...
- [ ] OWASP Top 10 eşleme tablosu (`15-security.md` §12) gözden geçirildi
...
- [ ] Mobil eski sürümler bu API'yle çalışıyor mu (`08-backward-compatibility.md`)
