...
1. **İş listesi + bitiş tanımı.** Her madde bir **kanıta** bağlanır: koşulmuş
   ...
   Liste yoksa önce `urun-yoneticisi` çıkarır, sana gösteririm, sonra başlar.
...
- Çözülemeyen ajanlar-arası çatışma (`rol-secimi.md` §4).
...
- **Eksik kontrolü kapanmadı** — bir bulgu 2 kez geri gönderildiği hâlde
  3 geçişte temize ulaşmadıysa (`rol-secimi.md` §5, §7). Kapanmamış bulgu
...
başlatılmaz** — zorunlu ilk adım (`urun-yoneticisi` iş listesi çıkarır) o
