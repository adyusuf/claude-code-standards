---
name: calisma-modu
description: Bu proje için çalışma modunu (A/B/C/D/E) gösterir veya değiştirir. Modlar ajan kullanımını, review'ı ve onay politikasını belirler. Kullanıcı "/calisma-modu", "modu değiştir", "hangi moddayız", "tam takım çalış", "ajansız çalış" dediğinde kullan.
---
...
B'nin üç ajanı (`analiz`, `test-yazar`, `belge`) varsayılanla birlikte onaylıdır.
...
⚠️ **X/Y/Z arşivdedir** (`modes/arsiv/README.md`) — mod olarak teklif edilmez.
...
## 4. Harf verildiyse (`/calisma-modu B`)
