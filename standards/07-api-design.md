...
- Sözleşme değişikliği **iki istemciyi birden** etkiler; mobil eski sürümde takılı kalabilir → `08-backward-compatibility.md` zorunlu okuma.
...
- Tercih: **versiyonsuz + additive evrim** (`08-backward-compatibility.md`). Bu neredeyse her zaman yeterlidir.
