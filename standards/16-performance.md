...
| Edge (Cloudflare) | Statik + nadiren değişen GET | `19-cloudflare-and-edge.md` |
...
- Üretimde p95 latency ve hata oranı dashboard'da; eşik aşımı alarm (`17-observability.md`).
