...
- Proje sözlüğü (`docs/glossary.md`) tutulur: Türkçe terim ↔ İngilizce kod karşılığı.
...
Şablon: `templates/adr-template.md`. Kısa olsun (1 sayfa), ama **reddedilen alternatifler**
