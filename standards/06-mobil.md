...
- Mobil istemci mağazada eski sürümde takılı kalabilir → **API geriye uyumluluğu mobilde hayati**. Bkz. `08-geriye-uyumluluk.md`.
...
- Yazma işlemleri çevrimdışıyken kuyruğa alınacaksa **idempotency key** ile gönderilir (`07-api-tasarimi.md`).
