...
(`20-hardening.md`) — Cloudflare bypass edilebilir.
...
- Sertifika süresi alarma bağlı (`17-observability.md` §7).
...
- **R2:** kullanıcı dosyaları. Bucket public yapılmaz; **imzalı URL** veya Worker proxy. Yükleme boyut/tip sınırı uygulama tarafında da doğrulanır. R2 içeriği de yedekleme kapsamındadır (`21-backup-and-recovery.md`).
...
- Token'lar sır envanterinde (`18-setup-and-environment.md` §4); rotasyon 6 ay.
