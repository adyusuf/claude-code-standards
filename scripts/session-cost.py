...
Kullanim:  python3 ~/.claude/scripts/session-cost.py <oturum-id>
           python3 ~/.claude/scripts/session-cost.py <oturum-id> --json
...
NEDEN VAR: modes/autonomous-run.md "her turda o ana kadarki harcama yazilir" ve
